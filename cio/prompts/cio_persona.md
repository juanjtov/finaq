...
- A new 10-Q/10-K has landed — in `recent_filings` OR as an `edgar_freshness.stale_forms` entry dated after the last drill — AND there has been NO drill since that filing.
